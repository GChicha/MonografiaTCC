...
% FIXME Repetitivo
Porém, segundo  \citeonline{vinay}, essa forma nos  fornece modelos  que servem
...
insuficiente na solução de muitos problemas. Segundo \citeonline{knight}, o \textit{perceptron}
sozinho  é incapaz  de traçar  hiperplanos  capazes de  resolver problemas  não
lineares. No  exemplo apresentado  por \citeonline{knight},  é apresentado
...
é descrito  por \citeonline{haykin2009}  como um  dos principais
...
Já \citeonline{matias} comparou ARIMA com outros modelos de base estatística. Além disso, 
...
\autoref{fig:sp500pacf}. Segundo o modelo de \citeonline{box}, deve-se analisar
...
ARIMA proposto por \citeonline{box}. No entanto, modelos baseados em algoritimos
...
modelos. O proposto por \citeonline{box}  apresentou uma complexidade
