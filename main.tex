...
insuficiente  na solução  de muitos  problemas. Segundo  \citeonline{knight}, o
\textit{perceptron} sozinho é incapaz de traçar hiperplanos capazes de resolver
problemas  não  lineares. No  exemplo  apresentado  por \citeonline{knight},  é
...
modelar  algumas superfícies,  \citeonline{knight} apresenta  que se  empregado
...
descrito por  \citeonline{haykin2009} como  um dos  principais objetivos  de um
modelo neural.
