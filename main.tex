...
temporais utilizando  algoritmos estatísticos e de aprendizado de  máquina. Como foi mostrado na seção de Trabalhos de Relacionados, é comum o uso de modelos  probabilísticos, em especial o modelo híbrido ARIMA  de \citeonline{box}, quando  se  realiza  a tarefa  de  previsão  de séries.  Mais  especificamente, o  modelo
