...
Fuller  descrito em  \citeonline{dickey} para  a prova  de estacionariedade,  é
suficiente  a observação  gráfica  da série.  Mas caso  não  seja conclusiva  a
...
\begin{equation}
    ...
    X_t = \sum_{i = 1}^{p}{\alpha_1X_{t-i}}+\epsilon_t
\end{equation}
...
segunda a \autoref{eq:pmediasmoveis}. Sendo os valores $\epsilon$ a defasagem
da série.
